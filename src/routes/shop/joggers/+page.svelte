<script lang="ts">
	...
	const product = {
		name: 'Custom Joggers',
		basePrice: 35,
		description: 'Comfortable jogger sweatpants with your custom artwork. Left leg, right leg, or both.',
		image: 'https://placehold.co/600x700/1e293b/ffffff?text=Joggers+Base'
	};
...
<svelte:head>
	<title>Custom Joggers | Triple B Prints</title>
	<meta name="description" content="Design your own custom joggers with Triple B Prints. Upload artwork, pick size, color, and print location." />
</svelte:head>
		...
		<div class="grid md:grid-cols-2 gap-12">
			...
			<div class="space-y-6">
				...
				<div
					...
					role="img"
					aria-label="Joggers preview showing your uploaded artwork"
					tabindex="0"
			...
			<div class="space-y-8">
				...
				<div>
					...
					<button
						...
						onclick={addToCart}
						aria-label={uploadedImage ? `Add custom joggers to cart for $${totalPrice}` : 'Upload artwork to enable checkout'}
						aria-live="polite"
					>
						{#if addedToCart}
