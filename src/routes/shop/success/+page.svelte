	...
	<div class="max-w-3xl mx-auto">
		...
		<div class="bg-white text-slate-900 rounded-3xl shadow-2xl p-8 md:p-12">
			...
			<div class="mt-8 flex flex-wrap gap-4">
				<a href="/shop/t-shirt" class="inline-flex items-center justify-center rounded-xl bg-slate-900 px-6 py-3 font-bold text-white hover:bg-slate-700 focus:outline-none focus:ring-4 focus:ring-yellow-400">
